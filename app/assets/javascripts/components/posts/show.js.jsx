            ...
            <div id="carousel-example-generic" className="carousel slide">
              ...
              <div className="carousel-inner">
                <div className="item active">
                  <img className="img-rounded" src={this.state.post.images.length > 0 ? "https://res.cloudinary.com/"+window.cloudinary_name+"/image/upload/c_fill,h_250,w_300/" + this.state.post.images[0].url : "https://res.cloudinary.com/"+window.cloudinary_name+"/image/upload/c_fill,h_250,w_300/v1445620195/no_image_opkcui.jpg"}/>
                </div>
                  ...
                  if(idx > 0){
                    return(
                      <div key={idx} className="item">
                        <img className="img-rounded" src={"https://res.cloudinary.com/"+window.cloudinary_name+"/image/upload/c_fill,h_250,w_300/" + image.url}/>
                      </div>
                    );
                  }
                })}
