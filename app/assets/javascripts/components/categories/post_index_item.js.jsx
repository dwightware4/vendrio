      ...
      <li data-id={this.props.post.id} onClick={this.showPost} onMouseEnter={this.addMarkerHighlight} onMouseLeave={this.removeMarkerHighlight} className="list-group-item cursor-pointer">
        ...
        <div className="row">
          <div className="col-xs-4">
                  <img className="img-rounded" src={this.props.post.images.length > 0 ? "https://res.cloudinary.com/"+window.cloudinary_name+"/image/upload/c_fill,h_100,w_120/" + this.props.post.images[0].url : "https://res.cloudinary.com/"+window.cloudinary_name+"/image/upload/c_fill,h_100,w_120/v1445620195/no_image_opkcui.jpg"}/>
          </div>
