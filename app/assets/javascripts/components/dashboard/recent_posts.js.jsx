            ...
            return(
              <div key={post.id} className="col-xs-4 test-class-name">
                ...
                <a href={"#/post/" + post.id} className="thumbnail">
                  <img className="img-rounded" src={post.images ? "http://res.cloudinary.com/vendrio/image/upload/c_fill,h_250,w_300/" + post.images[0].url : "http://res.cloudinary.com/vendrio/image/upload/c_fill,h_250,w_300/v1445036262/no-image_pi8xii.png"}/>
